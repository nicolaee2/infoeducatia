...
if(isset($_POST['submit']))
{
	...
	$url = "http://localhost/proiect/infoeducatia/public/php/create-new-pass.php?selector=" . $selector . "&validator=" . bin2hex($token);
	...
	else
	{
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'infoeducatia3@gmail.com'; // email
        $mail->Password = 'Infoeducatia1'; // password
        $mail->setFrom("infoeducatia3@gmail.com", "InfoEducatia"); // From email and name
        $mail->addAddress( $userEmail, 'InfoEducatia'); // to email and name
